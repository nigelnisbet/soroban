...
import { MultiplicationPrototype } from './components/multiplication/MultiplicationPrototype.mobile';
import { SorobanDrill } from './components/drill/SorobanDrill.mobile';
